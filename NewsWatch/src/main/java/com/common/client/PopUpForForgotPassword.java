...
//		buttonClose.addClickListener(this);
	...
	public PopUpForForgotPassword(String message, ClickHandler handler)
	{
		this();
		label = new Label(message);
		label.setStylePrimaryName("popupLabel");
		...
		vertical.setStylePrimaryName("verticalPopup");
//		buttonClose.addClickListener(this);
		buttonClose.addClickHandler(handler);
		vertical.add(label);
		vertical.add(buttonClose);
		vertical.setSpacing(5);
		add(vertical);
...
//		buttonClose.addClickListener(this);
	...
	public void createPopUpForForgotPasswordChanged(String message)
	{
		label = new Label(message);
		label.setStylePrimaryName("popupLabel");
		...
		hp.setStylePrimaryName("verticalPopup");
